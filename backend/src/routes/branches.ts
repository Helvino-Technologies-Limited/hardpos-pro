...
router.post('/', requireAdmin, async (req: AuthRequest, res: Response) => {
  try {
    ...
    const result = await query(`INSERT INTO branches (tenant_id, name, code, address, city, phone, email, is_main, status) VALUES ($1,$2,$3,$4,$5,$6,$7,false,'active') RETURNING *`, [req.user!.tenantId, name, code, address, city, phone, email]);
